...
function CommentCard({
  ...
  const [bodyExpanded, setBodyExpanded] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
      ...
      children: [comment.avatarUrl ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("img", {
        ...
        className: "flow-comment-card__byline",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("span", {
          className: "flow-comment-card__author",
          title: comment.author,
          children: comment.author
        }), comment.isAgent && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("span", {
          className: "flow-comment-card__agent",
          children: "AI"
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("span", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
        ref: bodyRef,
        role: "presentation",
        className: `flow-comment-card__body${truncated && !expanded ? ' flow-comment-card__body--truncated' : ''}`,
      ...
      }), truncated && !isThreadExpanded && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("button", {
        type: "button",
        className: "flow-comment-card__more",
        onClick: () => setBodyExpanded(prev => !prev),
        children: bodyExpanded ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show less', 'jumplinks-editorial-workflow') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Read more', 'jumplinks-editorial-workflow')
      })]
    })]
  });
}
...
function GeneralCommentsPanel({
  ...
  const handleReply = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (parentId, html, reopen = false) => {
    const comment = await api.postComment({
      html,
      parentId
    });
    appendComment(comment);
    if (reopen) {
      await api.updateComment(parentId, {
        resolved: false
      });
...
function CommentThread({
  ...
  const [reopen, setReopen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    ...
    }), onResolve && !replyingTo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
    ...
    }), replyingTo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      className: "flow-comment-thread__reply-editor",
      ref: replyEditorRef,
      children: [thread.isResolved && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("label", {
        className: "flow-comment-thread__reopen",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("input", {
          type: "checkbox",
          checked: reopen,
          onChange: e => setReopen(e.target.checked)
        }), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Reopen this thread', 'jumplinks-editorial-workflow')]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_CommentEditor__WEBPACK_IMPORTED_MODULE_6__["default"], {
        autoFocus: true,
...
function InlineCommentsPanel({
  ...
  const handleReply = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (parentId, html, reopen = false) => {
    ...
    if (reopen) {
      ...
      setComments(prev => prev.map(c => Number(c.id) === pid ? {
        ...c,
        isResolved: false
      } : c));
      window.dispatchEvent(new CustomEvent('flow:highlight-resolve', {
...
function CommentAuthorRow({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
    ...
    children: [comment.avatarUrl ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("img", {
      ...
      className: "flow-thread-popover__byline",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "flow-thread-popover__author",
        title: comment.author,
        children: comment.author
      }), comment.isAgent && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "flow-thread-popover__agent",
        children: "AI"
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
...
function InlineThreadPopover({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
      ...
      }), replying && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
        className: "flow-thread-popover__reply-editor",
        children: [thread.isResolved && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("label", {
          className: "flow-thread-popover__reopen",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("input", {
            type: "checkbox",
            checked: reopen,
            onChange: e => setReopen(e.target.checked)
          }), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Reopen this thread', 'jumplinks-editorial-workflow')]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_CommentEditor__WEBPACK_IMPORTED_MODULE_10__["default"], {
          autoFocus: true,
          onSubmit: handleReplySubmit,
...
function sameComment(a, b) {
  return a.html === b.html && a.isResolved === b.isResolved && a.isAgent === b.isAgent && a.parentId === b.parentId && a.author === b.author && a.anchorText === b.anchorText;
}
...
function seenKey() {
  ...
  const email = String(pageData.inviteEmail || '').trim().toLowerCase();
...
function buildHintVideo(doc) {
  const pageData = window.flowReviewPage || {};
  const sources = [[pageData.hintVideoWebm, 'video/webm'], [pageData.hintVideoMp4, 'video/mp4']].filter(([url]) => !!url);
  if (!sources.length) {
    return null;
  }
...
function installCommentableChrome(options = {}) {
  ...
  const title = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add inline comments', 'jumplinks-editorial-workflow');
  ...
  confirm.type = 'button';
  confirm.className = 'flow-review-info-notice__btn flow-review-info-notice__btn--primary';
  confirm.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Got it, let me start', 'jumplinks-editorial-workflow');
...
function handleResolve(e) {
  ...
  // Reopening a thread sends the same event with `resolved: false`.
  queryHighlightedByCommentId(commentId).forEach(mark => mark.classList.toggle(RESOLVED_CLASS, !!resolved));
}
